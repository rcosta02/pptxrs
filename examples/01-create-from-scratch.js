...
async function main() {
  ...
  slide1.setBackground("002060");
  slide1.addText("pptxrs", {
    x: 1,
    y: 1.5,
    w: 8,
    h: 1.5,
  ...
  slide1.addText("Create · Read · Modify · Export .pptx files", {
    x: 1,
    y: 3.2,
    w: 8,
    h: 0.8,
  ...
  slide1.addText("Powered by Rust + WebAssembly", {
    x: 1,
    y: 4.5,
    w: 8,
    h: 0.5,
  ...
  slide1.addNotes("Welcome slide. Mention the Rust/WASM architecture.");

  // ── Slide 2 — Text styles ───────────────────────────────────────────────────
  const slide2 = pres.addSlide();
  slide2.addText("Text Styles", {
    x: 0.5,
    y: 0.2,
    w: 9,
    h: 0.7,
  ...
  slide2.addText("Bold  Italic  Underline  Strike  Highlight", {
    x: 0.5,
    y: 1.1,
    w: 9,
    h: 0.6,
  ...
  slide2.addText("Click here → pptxrs on GitHub", {
    x: 0.5,
    y: 2.8,
    w: 5,
    h: 0.5,
  ...
  slide2.addText("Shadow & Glow Effects", {
    x: 5,
    y: 3.4,
    w: 4.5,
    h: 1.2,
  ...
  slide2.addNotes("All major text formatting options are shown on this slide.");

  // ── Slide 3 — Shapes ────────────────────────────────────────────────────────
  const slide3 = pres.addSlide();
  slide3.addText("Shapes", {
    x: 0.5,
    y: 0.2,
    w: 9,
    h: 0.7,
  ...
  ].forEach(({ type, x, fill, rectRadius }) => {
    slide3.addShape(type, {
      x,
      y: 0.9,
      w: 1.6,
      h: 1.4,
  ...
  slide4.addNotes("Performance review table with conditional color coding.");

  // ── Slide 5 — Charts ────────────────────────────────────────────────────────
  const slide5 = pres.addSlide();
  slide5.addText("Charts", {
    x: 0.5,
    y: 0.1,
    w: 9,
    h: 0.5,
  ...
  slide6.addText("Line & Scatter Charts", {
    x: 0.5,
    y: 0.1,
    w: 9,
    h: 0.5,
