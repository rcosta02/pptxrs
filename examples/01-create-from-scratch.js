...
async function main() {
  ...
  pres.addSlide(null, slide => {
    ...
    // Hyperlink
    slide.addText('Click here → pptrs on GitHub', {
      x: 0.5, y: 2.8, w: 5, h: 0.5,
      fontSize: 16,
      color:    '0563C1',
      underline: true,
    ...
    slide.addText([
      ...
      { text: 'Numbered item one',   options: { bullet: { type: 'number', style: 'arabicPeriod' } } },
      { text: 'Numbered item two',   options: { bullet: { type: 'number', style: 'arabicPeriod' } } },
      { text: 'Custom checkmark',    options: { bullet: { code: '2713', color: '70AD47', font: 'Wingdings 2' } } },
    ...
    slide.addNotes('All major text formatting options are shown on this slide.');
  });
  ...
  pres.addSlide(null, slide => {
    ...
    slide.addShape('ellipse', {
      ...
      shadow: { type: 'outer', angle: 45, blur: 8, color: '000000', opacity: 0.5 },
    });
  });
  ...
  pres.addSlide(null, slide => {
    ...
    slide.addTable(
      [
        ...
        [
          { text: 'Employee',   options: { bold: true, fill: '002060', color: 'FFFFFF', align: 'center' } },
          { text: 'Department', options: { bold: true, fill: '002060', color: 'FFFFFF', align: 'center' } },
          { text: 'Score',      options: { bold: true, fill: '002060', color: 'FFFFFF', align: 'center' } },
          { text: 'Status',     options: { bold: true, fill: '002060', color: 'FFFFFF', align: 'center' } },
        ],
        ['Alice Zhang',  'Engineering', '97', { text: 'Exceeds',  options: { color: '00B050', bold: true } }],
        ['Bob Marley',   'Design',      '85', { text: 'Meets',    options: { color: '0070C0' } }],
        ['Carol White',  'PM',          '91', { text: 'Exceeds',  options: { color: '00B050', bold: true } }],
        ['David Kim',    'Engineering', '72', { text: 'Below',    options: { color: 'FF0000' } }],
        ['Eva Rossi',    'Marketing',   '88', { text: 'Meets',    options: { color: '0070C0' } }],
      ],
      {
        x: 0.5, y: 0.85, w: 9, h: 3.8,
  ...
  pres.addSlide(null, slide => {
    ...
    // Bar chart (left half)
    slide.addChart('bar', [
      { name: 'Revenue',  labels: ['Q1','Q2','Q3','Q4'], values: [120, 190, 160, 230] },
      { name: 'Expenses', labels: ['Q1','Q2','Q3','Q4'], values: [80,  110,  90, 130] },
    ], {
      x: 0.2, y: 0.7, w: 4.6, h: 4.7,
      barDir:       'col',
    ...
    slide.addChart('pie', [
      { labels: ['North', 'South', 'East', 'West'], values: [35, 25, 20, 20] },
    ], {
      x: 5.1, y: 0.7, w: 4.6, h: 4.7,
      showTitle:   true,
      title:       'Market Share',
      showPercent: true,
      showLegend:  true,
  ...
  pres.addSlide(null, slide => {
    ...
    slide.addChart('line', [
      { name: 'Product A', labels: ['Jan','Feb','Mar','Apr','May','Jun'], values: [42, 58, 51, 73, 68, 89] },
      { name: 'Product B', labels: ['Jan','Feb','Mar','Apr','May','Jun'], values: [30, 35, 45, 40, 60, 55] },
    ], {
      x: 0.2, y: 0.7, w: 4.6, h: 4.7,
      lineSmooth:        true,
      lineSize:          2.5,
    ...
    slide.addChart('scatter', [
      { name: 'Dataset 1', labels: ['A','B','C','D','E'], values: [10, 30, 20, 50, 40] },
    ], {
      x: 5.1, y: 0.7, w: 4.6, h: 4.7,
      showTitle:   true,
      title:       'Scatter Plot',
